        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <Text>Please select the tenure.</Text>
                    <View style={styles.selectOptions}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Submit")}>
                            <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                                <Text style={styles.textLogin}> 5 Years</Text>
                            </LinearGradient>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Submit")}>
                            <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                                <Text style={styles.textLogin}> 10 Years</Text>
                            </LinearGradient>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Submit")}>
                            <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                                <Text style={styles.textLogin}> 15 Years</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Submit")}>
                            <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                                <Text style={styles.textLogin}> 20 Years</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                </View>

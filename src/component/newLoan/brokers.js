    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text>Please select the brokage firm name</Text>
                <View style={styles.selectOptions}>

                    <TouchableOpacity onPress={() => this.props.navigation.navigate("Tenure")}>
                        <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.submitButton}>
                            <Text style={styles.buttonText}> Shrikant D Pandore</Text>
                        </LinearGradient>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("Tenure")}>
                        <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.submitButton}>
                            <Text style={styles.buttonText}> Pramod Godekar</Text>
                        </LinearGradient>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("Tenure")}>
                        <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.submitButton}>
                            <Text style={styles.buttonText}> Prasanna Mohanty</Text>
                        </LinearGradient>
                    </TouchableOpacity>
                </View>
            </View>

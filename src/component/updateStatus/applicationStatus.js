        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <Text>Your loan application is pending for the customer acceptance. Would you like to view the loan agreement.</Text>
                    <View style={styles.selectOptions}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("LoanAgreement", {"contractId": this.state.contractId})}>

        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <Text> Name Of Broker - Shrikant D Pandore </Text>
                    <Text> Lien Amount - Rs. 100000/- </Text>
                    <Text> Would you like to accept it? </Text>
                    <View style={styles.selectOptions}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("SubmitStatus", {"contractId": this.state.contractId})}>
                            <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                                <Text style={styles.textLogin}>Accept</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("SubmitStatus", {"contractId": this.state.contractId})}>
                            <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                                <Text style={styles.textLogin}>Reject</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                </View>

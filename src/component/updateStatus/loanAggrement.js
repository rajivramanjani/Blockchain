        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <Text> Loan Amount - Rs.100000/- </Text>
                    <Text> Intrest Rate - 12% </Text>
                    <Text> Tenure - 5 Years </Text>
                    <Text> EMI - Rs. 1666/- </Text>
                    <View style={styles.selectOptions}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("ControlAgreement", {"contractId": this.state.contractId})}>

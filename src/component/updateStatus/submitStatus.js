...
export default class ContactComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('https://p8blkchwkbench-bk3m3c-api.azurewebsites.net//api/v2/contracts/' + this.state.contractId + '/actions', {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                "workflowFunctionID": 2426,
                "workflowActionParameters": [
                  {
                   "name": "Comments",
                    "value": "approved",
                    "workflowFunctionParameterId": 4004
                  }
                ]
              })
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                <Text>Thank you!</Text>
                <Text>Your loan and control agreements have been sent to the bank successfully.</Text>

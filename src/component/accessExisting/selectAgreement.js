    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text>Please select the agreement.</Text>
                <View style={styles.selectOptions}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("LoanAgreementExisting")}>
                        <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                            <Text style={styles.textLogin}> Loan Agreement </Text>
                        </LinearGradient>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => this.props.navigation.navigate("ControlAgreementExisting", {"contractId": this.state.contractId})}>
                        <LinearGradient start={{ x: 0, y: 0 }} colors={['#39b54a', '#006837']} style={styles.login}>
                            <Text style={styles.textLogin}> Control Agreement </Text>
                        </LinearGradient>
                    </TouchableOpacity>
                </View>
                </View>            
